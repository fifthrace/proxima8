...
*   **Gameplay Data:** Any progress you make in the game (completed levels, settings) is stored locally on your device. We do not transmit this data to any external servers.

### 2. Third-Party Services
The App may use third-party services that may collect information used to identify you. 
*   **Google Play Services:** Used for app distribution and basic usage analytics provided by Google. You can view their privacy policy here: [https://policies.google.com/privacy](https://policies.google.com/privacy)
